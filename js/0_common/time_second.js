...
Calendar.prototype.draw = function() {
    ...
    mvAry[mvAry.length] = '        <th align="left" width="40%" style="margin-left:20px"  nowrap="nowrap">' +
        '<select name="calendarYear" id="calendarYear" style="font-size:12px;float: left;margin-left: 30px;margin-top: 2px"></select>' +
        '<select name="calendarMonth" id="calendarMonth" style="font-size:12px;margin-left: 30px;margin-top: 2px;';if (calendar.DateMode > pickMode["month"]) {mvAry[mvAry.length] = 'display:none;';} //pickMode 精确到年时隐藏 “月”
    ...
    mvAry[mvAry.length] = '        <input name="calendarClear" type="button" id="calendarClear" value="' + Calendar.language["clear"][this.lang] + '" style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:60px;height:30px;font-size:12px;cursor:pointer;margin-left: -15px"/>';
